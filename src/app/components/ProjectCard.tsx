...
export default function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <div className="group relative flex flex-col h-full rounded-2xl sm:rounded-3xl overflow-hidden bg-white/5 backdrop-blur-xl border border-white/10 hover:border-cyan-400/50 transition-all duration-500 hover:shadow-[0_20px_50px_rgba(8,145,178,0.3)] shadow-2xl">
      ...
      {/* Image / icon area */}
      <div className="relative pointer-events-none w-full aspect-[16/10] overflow-hidden bg-white flex items-center justify-center p-8 sm:p-10">
        {project.image ? (
      ...
      {/* Content */}
      <div className="relative pointer-events-none p-5 sm:p-6 flex flex-col flex-grow bg-gradient-to-b from-transparent to-black/20">
        ...
        <div className="mt-auto flex flex-col gap-4">
          ...
          {/* Store/Repo links stay interactive above overlay link */}
