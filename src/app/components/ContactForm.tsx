    ...
    return (
        <div className="relative w-full max-w-2xl mx-auto">
            ...
            >
                ...
                <button
                    type="submit"
                    className="flex items-center justify-center gap-2 self-start w-[200px] h-[45px] rounded-full bg-teal-400 text-black font-semibold hover:bg-teal-500 transition shadow-md"
                >
                    Send Message
                    <Image
                        src="/send.png"
                        ...
                        width={24}
                        height={24}
                        className="pt-[5px]"  // adds 10px top padding
                    />
                </button>
